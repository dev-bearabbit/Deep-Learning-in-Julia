...
function  predict(input)
    ...
    pconv_4 = convolution2D_forward(pre_dense, pconv_Re_3 , params["W4"], params["b4"],1,1)
...
weight_size = [(3,3,1,16),(3,3,16,16),(3,3,16,32),(3,3,32,32),(3,3,32,64),(3,3,64,64),(576,64),(64,10)];
output_shape = [(28,28,1),(28,28,16),(14,14,16),(14,14,32),(7,7,32),(7,7,64),(3,3,64),(100,64)];
...
@time begin
    for i in 1:600
        ...
        conv_4 = convolution2D_forward(dense4,conv_Re_3,params["W4"],params["b4"],1,1)
        ...
        conv_4_back = convolution2D_backward(dense4,conv_Re_4_back,1,1)
        grads["W4"] = dense4.dw
        grads["b4"] = dense4.db
